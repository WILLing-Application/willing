...
| GET	      | /albums/{id}        | Single album view | /albums/albums.html   |               |
...
| GET         | /items/{id}         | Single Item view, interest icon & ranking form | /items/items.html & interests.html ? | WILLing Items Views.pdf |
